...
{
  struct MHD_Response **responseptr = (MHD_Response **)cls;
          ...
          const char *upload_data, size_t *upload_data_size, void **ptr)
{
  ...
  responseptr = (MHD_Response **)malloc (sizeof (struct MHD_Response *));
  response = (MHD_Response *)MHD_create_response_from_callback (MHD_SIZE_UNKNOWN,
                                                1024,
