...
#cmakedefine HAVE_GNUTLS_GNUTLS_H

/* Provides IPv6 headers */
#undef HAVE_INET6   /* needs work */
...
#cmakedefine HAVE_MESSAGES   /* check what this does */
...
#cmakedefine HAVE_SOCKADDR_IN_SIN_LEN

/* SOCK_NONBLOCK is defined in a socket header */
#cmakedefine HAVE_SOCK_NONBLOCK
...
#cmakedefine LIBCURL_FEATURE_NTLM
#cmakedefine LIBCURL_FEATURE_NTLM_WB
...
#cmakedefine LIBCURL_PROTOCOL_IMAP

/* Defined if libcurl supports LDAP */
#cmakedefine LIBCURL_PROTOCOL_LDAP

/* Defined if libcurl supports POP3 */
#cmakedefine LIBCURL_PROTOCOL_POP3

/* Defined if libcurl supports RTSP */
#cmakedefine LIBCURL_PROTOCOL_RTSP

/* Defined if libcurl supports SMTP */
#cmakedefine LIBCURL_PROTOCOL_SMTP
...
#cmakedefine MHD_USE_POSIX_THREADS
